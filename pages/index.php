	...
	<div class="view first_back" style="background-image: url('../resources/background_updated.png'); background-repeat: repeat-y; background-size: cover; background-position: center center;">
		...
		<nav class="navbar navbar">
		 	...
		 	<div class="dropdown">
		 		...
		 		if (isset($_SESSION['user']) && !isset($_GET['signout'])) {
		 			...
		 			echo '<div class="dropdown-content">
		 				  	<a href="index.php?myrecipes=1"><span><i class="fa fa-book"></i></span>&nbspMy Recipes</a>
		 				  	<a href="index.php?signout=1"><span><i class="fa fa-sign-out"></i></span>&nbspSignout</a>
		 				  </div>';
		 				...
		 				echo '<div class="dropdown-content">
		 					 	<a href="login.php"><span class="glyphicon glyphicon-log-in"></span>&nbspLogin</a>
		 					 	<a href="register.php"><span class="glyphicon glyphicon-user"></span>&nbspRegister</a>
		 	...
		 	<div class="navbar-header">
		 		<h3 class="title"><a href="index.php">Many Meals</a></h3>
		 	</div>
		 	...
		 	<ul class="nav navbar-nav">
		    	...
		    	if (isset($_SESSION['user']) && !isset($_GET['signout'])) {
		    		echo '<li><a id="create" href="#">Create a Recipe</a></li>';
		    	}
		    	?>
		...
		<div class="content">
			...
			<!-- this is a redirecting page don't touch it -->
